...
//                   _menuItem(context, "Leave & Week Off", Icons.beach_access),
...
class SettingsPage extends StatelessWidget {
  ...
  void _handleItemClick(BuildContext context, String title) {
    if (title == 'Workdays & Shift Permission') {
      ...
      // <-- Navigate to the details-entry form:
      Navigator.push(
        context,
    ...
    child: Container(
      ...
      child: Row(
        children: [
          Icon(icon, size: 20, color: kTextColor),
          const SizedBox(width: 12),
          Expanded(child: Text(title, style: const TextStyle(color: kTextColor, fontSize: 15.5, fontWeight: FontWeight.w500))),
          const Icon(Icons.arrow_forward_ios, size: 16, color: kTextColor),
        ],
      ),
    ),
