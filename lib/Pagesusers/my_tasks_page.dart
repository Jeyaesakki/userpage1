          ...
          child: Column(
            children: [
              Container(
                ...
                child: const Text("Task Assigned", textAlign: TextAlign.center, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ),
              const SizedBox(height: 10),
              ElevatedButton(
                onPressed: _viewTaskDetails,
              ...
              Container(
                ...
                child: const Text("Daily Update Upload", textAlign: TextAlign.center, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ),
              const SizedBox(height: 10),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,
