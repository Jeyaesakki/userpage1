...
//     if (picked != null && _isTimeInShift(picked)) {
...
//     } else if (picked != null) {
//       ScaffoldMessenger.of(context).showSnackBar(
//         const SnackBar(content: Text('Selected time is outside the allowed shift time.')),
//       );
//     }
//   }

//   bool _isTimeInShift(TimeOfDay picked) {
//     final totalMinutes = picked.hour * 60 + picked.minute;
//     switch (selectedShift) {
//       case 'Shift 1':
//         return totalMinutes >= 360 && totalMinutes <= 840; // 6:00 AM to 2:00 PM
//       case 'Shift 2':
//         return totalMinutes >= 510 && totalMinutes <= 990; // 8:30 AM to 4:30 PM
//       case 'Shift 3':
//         return totalMinutes >= 540 || totalMinutes <= 300; // 9:00 AM to 5:00 AM (next day)
//       default:
//         return false;
//     }
//   }
